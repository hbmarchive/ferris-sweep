...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE_LAYER] = LAYOUT_split_3x5_2(
    ...
    KC_SPC, OSM(MOD_LSFT), OSL(SYM_LAYER), KC_ENT
  ),
  [SYM_LAYER] = LAYOUT_split_3x5_2(
    ...
    KC_SPC, TO(BASE_LAYER), TO(NAV_LAYER), KC_ENT
  ),
  [NAV_LAYER] = LAYOUT_split_3x5_2(
    ...
    KC_SPC, TO(BASE_LAYER), KC_NO, KC_ENT
  ),
  [FUNC_LAYER] = LAYOUT_split_3x5_2(
    ...
    KC_SPC, TO(BASE_LAYER), TO(SYM_LAYER), KC_ENT
  ),
